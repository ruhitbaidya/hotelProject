      ...
      <div className="container mx-auto py-20 px-4 backdrop-brightness-75">
        <div className="text-center space-y-6 max-w-2xl mx-auto">
          ...
          <div className="flex items-center justify-center">
            <div className="flex bg-white rounded-xl overflow-hidden shadow-md w-full max-w-lg">
              <input
                type="email"
              ...
              <button className="bg-[#0466c8] hover:bg-[#0466c8] text-white px-6 flex items-center gap-2 font-semibold transition">
